<div class="btn-group blog-comment">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[author]" class="col-sm-2 control-label">
                                        {!! trans('blog::comment.label.author')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[author]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[blog_id]" class="col-sm-2 control-label">
                                        {!! trans('blog::comment.label.blog_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[blog_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".blog-comment .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/blog.comment.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".blog-comment .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.blog-comment .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'blog.comment.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#blog-comment-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#blog-comment-list .btn-reset-filter').css('display', 'none');
