<div class="btn-group blog-category">
...
$(document).ready(function(){
    ...
    $(".blog-category .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/blog.category.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".blog-category .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.blog-category .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'blog.category.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#blog-category-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#blog-category-list .btn-reset-filter').css('display', 'none');
