...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[frequency]" class="col-sm-2 control-label">
                                        {!! trans('blog::tag.label.frequency')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[frequency]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            {{--<div class="col-md-6">
...
<div class="modal fade" id="modal-open">
  <div class="modal-dialog">
    <div class="modal-content" style="max-width:400px;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger"  name="Closerep" data-dismiss="modal"><i class="fa fa-times-circle"></i> 关闭 </button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
$(document).ready(function(){
    ...
    $(".blog-tag .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/blog.tag.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".blog-tag .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.blog-tag .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'blog.tag.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#blog-tag-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#blog-tag-list .btn-reset-filter').css('display', 'none');
